  ...
  const permissionCategories: { title: string; perms: { key: Permission; label: string }[] }[] = [
    {
      ...
      perms: [
        { key: 'students:view_all', label: 'View All Students Roster' },
        { key: 'students:view_own', label: 'View Own Student Profile' },
        { key: 'students:enroll', label: 'Enroll New Students' },
        { key: 'students:edit_records', label: 'Edit Student Records' },
        { key: 'students:academic_docs', label: 'Manage Transcripts & Diplomas' },
      ],
    },
    {
      title: 'Attendance & Class Sessions',
      perms: [
        { key: 'attendance:view_all', label: 'View Institutional Attendance' },
        { key: 'attendance:view_own', label: 'View Own Attendance Record' },
        { key: 'attendance:mark_assigned', label: 'Take Class Attendance' },
        { key: 'attendance:mark_all', label: 'Batch Mark Attendance' },
        { key: 'attendance:override', label: 'Administrative Attendance Override' },
      ],
    },
    {
      title: 'Academics, Grades & Quizzes',
      perms: [
        { key: 'grades:view_all', label: 'View All Student Grades & GPA' },
        { key: 'grades:view_assigned', label: 'View Course Roster Grades' },
        { key: 'grades:view_own', label: 'View Own Grades & Transcripts' },
        { key: 'grades:submit_grade', label: 'Grade Exams & Assign Scores' },
        { key: 'academics:manage_courses', label: 'Create/Edit Course Offerings' },
        { key: 'assignments:manage', label: 'Create Homework & Quizzes' },
      ],
    },
    {
      title: 'Finance, Tuition & Payments',
      perms: [
        { key: 'finance:view_all', label: 'View Institutional Ledger & Balances' },
        { key: 'finance:view_own', label: 'View Own Tuition Invoices & Receipts' },
        { key: 'finance:record_payment', label: 'Record Transactions & Generate Receipts' },
        { key: 'finance:adjustments', label: 'Apply Scholarships, Discounts & Refunds' },
        { key: 'finance:reports', label: 'Export Financial Statements & Audits' },
      ],
    },
    {
      title: 'Library, Resources & Governance',
      perms: [
        { key: 'library:manage', label: 'Manage Digital Library Syllabi & Books' },
        { key: 'library:borrow', label: 'Borrow & Download Resources' },
        { key: 'reports:view_all', label: 'Generate Institutional Reports' },
        { key: 'audit_logs:view', label: 'View System Audit Trail & Security Logs' },
      ],
    },
  ];
